...
## Fork Changes (langcore-org/claude-code-action@beta)
...
- **Updated Base Action**: Uses `langcore-org/claude-code-base-action@beta` which includes OAuth credential handling
